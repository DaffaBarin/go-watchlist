...
func (_m *Repository) Create(domain *medias.Domain) (medias.Domain, error) {
...
func (_m *Repository) GetAll() ([]medias.Domain, error) {
	ret := _m.Called()
...
func (_m *Repository) GetByID(id int) (medias.Domain, error) {
	ret := _m.Called(id)
